...
print("The expected result of integer division of 10 dived by 3 is 3.")
...
print("This result is different because it contains the remainder.")
/*:
...
let integer =  12 % 5
print("Remainder of 12 / 5:", integer)
...
print("Odd:", odd % 2)
print("Even:", even % 2)
print("We can use the remainder operator to determine parity by determining if upon division by 2 there is a remainder of 1 (odd) or a remainder of 0 (even).")
/*:
