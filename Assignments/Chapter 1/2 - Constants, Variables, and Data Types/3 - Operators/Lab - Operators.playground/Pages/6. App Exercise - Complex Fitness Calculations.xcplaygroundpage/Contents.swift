 ...
 */
let heartRate1 : Double = 61
let heartRate2 : Double = 80
let heartRate3 : Double = 100
let averageHeartRate : Double = (heartRate1 + heartRate2 + heartRate3) / 3.0
...
print("Fahrenheit:", tempInFahrenheit)
let tempInCelsius = (tempInFahrenheit - 32.0) * (5.0 / 9.0)
print("Celsius:", tempInCelsius)
/*:
